...
<div class="content-body">
  <div class="row">
    <form id="form" class="" action="<?=base_url()?>kar_category/<?=$action?>" method="post">
      <div class="col-md-6">
        ...
        <div class="form-group">
          <label>Service karaoke<small class="required-field">*</small></label>
          <input class="form-control" type="text" id="service_karaoke" name="service_karaoke" readonly value="<?php if($category != null){echo num_to_price($category->service_karaoke);}?>">
        </div>
        <div class="form-group">
          <label>Pajak karaoke<small class="required-field">*</small></label>
        ...
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>kar_category/index"><i class="fa fa-close"></i> Batal</a>
