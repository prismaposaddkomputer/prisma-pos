...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>hot_module/form"><i class="fa fa-plus"></i> Tambah Modul</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>hot_module/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>hot_module/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>hot_module/delete/"+id;
    })
  }
</script>
