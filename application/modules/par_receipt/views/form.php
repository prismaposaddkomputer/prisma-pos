...
<div class="content-body">
  <div class="row">
    <form id="form" class="" action="<?=base_url()?>par_receipt/<?=$action?>" method="post">
      <div class="col-md-6">
        <h4>Header</h4>
      ...
      <div class="col-md-12">
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>par_receipt/index"><i class="fa fa-close"></i> Batal</a>
