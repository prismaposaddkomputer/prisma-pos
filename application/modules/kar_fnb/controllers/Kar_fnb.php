...
class Kar_fnb extends MY_Karaoke {
	...
	public function index()
  {
    if ($this->access->_read == 1) {
      ...
      if($this->session->userdata('search_term') == null){
        ...
        $data['fnb'] = $this->m_kar_fnb->get_list($config['per_page'],$from,$search_term = null);
      }else{
        ...
        $data['fnb'] = $this->m_kar_fnb->get_list($config['per_page'],$from,$search_term);
      }
  ...
  public function form($id = null)
  {
    ...
    if ($id == null) {
      ...
      if ($this->access->_update == 1) {
        ...
        $data['fnb'] = $this->m_kar_fnb->get_by_id($id);
  ...
  {
    $data['fnb']= $this->m_kar_fnb->get_specific($id);
