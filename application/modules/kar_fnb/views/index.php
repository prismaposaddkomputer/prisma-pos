...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>kar_fnb/form"><i class="fa fa-plus"></i> Tambah FnB</a>
    ...
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>kar_fnb/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>kar_fnb/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($fnb_type as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>kar_fnb/form/<?=$row->fnb_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>kar_fnb/delete/"+id;
    })
  }
</script>
