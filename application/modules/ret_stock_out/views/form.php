...
<div class="content-body">
  <form id="form" class="" action="<?=base_url()?>ret_stock_out/<?=$action?>" method="post">
    <div class="row">
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>ret_stock_out/index"><i class="fa fa-close"></i> Batal</a>
