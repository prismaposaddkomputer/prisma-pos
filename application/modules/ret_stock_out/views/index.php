...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>ret_stock_out/form"><i class="fa fa-plus"></i> Tambah Stok Keluar</a>
    </div>
    <div class="col-md-8 col-lg-7 pull-right">
      <form class="" action="<?=base_url()?>ret_stock_out/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>ret_stock_out/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
    </div>
              ...
              <?php $i=1;foreach ($stock_out as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->tx_id != '' ): ?>
                      <a class="btn btn-xs btn-success" href="<?=base_url()?>ret_stock_out/detail/<?=$row->tx_id?>/<?=$row->tx_type?>"><i class="fa fa-list"></i></a>
                    <?php endif; ?>
                  </td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>ret_stock_out/delete/"+id;
    })
  }
</script>
