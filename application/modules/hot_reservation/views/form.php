  ...
  <form id="form" class="" action="<?=base_url()?>hot_reservation/<?=$action?>" method="post">
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <h5 class="cl-success"><strong><i class="fa fa-arrow-down"></i> Check In (Masuk)</strong></h5>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
        ...
        <h5 class="cl-danger"><strong><i class="fa fa-arrow-up"></i> Check Out (Keluar)</strong></h5>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Tanggal <b class="required-field">*</b></small></label>
              <input class="form-control date-picker" type="text" name="billing_date_out" value="<?php if($billing != null){echo ($billing->billing_date_out == 0) ? date("d-m-Y") : date_to_ind($billing->billing_date_out) ;}else{echo date('d-m-Y');}?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label>Waktu <b class="required-field">*</b></small></label>
              <input class="form-control time-picker" type="text" name="billing_time_out" value="<?php if($billing != null){echo ($billing->billing_time_out == 0) ? date("H:i:s") : $billing->billing_time_out ;}else{echo date('H:i:s');}?>">
            </div>
          </div>
        </div>
...
<!-- Modals -->
<!-- Kamar List -->
<?php $this->view('hot_reservation/_kamar_list'); ?>

<!-- Kamar -->
<?php $this->view('hot_reservation/_kamar'); ?>

<!-- Kamar Update -->
<?php $this->view('hot_reservation/_kamar_update'); ?>

<!-- Extra List -->
<?php $this->view('hot_reservation/_extra_list'); ?>

<!-- Extra -->
<?php $this->view('hot_reservation/_extra'); ?>

<!-- Extra Update -->
<?php $this->view('hot_reservation/_extra_update'); ?>

<!-- Service List -->
<?php $this->view('hot_reservation/_service_list'); ?>

<!-- Service -->
<?php $this->view('hot_reservation/_service'); ?>

<!-- Service Update -->
<?php $this->view('hot_reservation/_service_update'); ?>

<!-- Paket List -->
<?php $this->view('hot_reservation/_paket_list'); ?>

<!-- Paket -->
<?php $this->view('hot_reservation/_paket'); ?>

<!-- Fnb List -->
<?php $this->view('hot_reservation/_fnb_list'); ?>

<!-- FnB -->
<?php $this->view('hot_reservation/_fnb'); ?>

<!-- FnB -->
<?php $this->view('hot_reservation/_fnb_update'); ?>

<!-- Non Pajak List -->
<?php $this->view('hot_reservation/_non_pajak_list'); ?>

<!-- Non Pajak -->
<?php $this->view('hot_reservation/_non_pajak'); ?>

<!-- Non Pajak Update -->
<?php $this->view('hot_reservation/_non_pajak_update'); ?>

<!-- Custom List -->
<?php $this->view('hot_reservation/_custom_list'); ?>

<!-- Custom -->
<?php $this->view('hot_reservation/_custom'); ?>

<!-- Custom Update -->
<?php $this->view('hot_reservation/_custom_update'); ?>


<!-- Javascript -->
<?php $this->view('hot_reservation/_js'); ?>
