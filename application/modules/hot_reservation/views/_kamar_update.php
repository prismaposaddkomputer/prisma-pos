        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <br>
                <label class="radio-inline">
                   <input type="radio" name="update_room_st_denda" class="update_room_st_denda" id="update_room_st_denda_1" value="1"/> Isi Otomatis
                </label>
                &nbsp;&nbsp;&nbsp;
                <label class="radio-inline">
                   <input type="radio" name="update_room_st_denda" class="update_room_st_denda" id="update_room_st_denda_2" value="2" checked=""/> Isi Manual
                </label>
            </div>
            <div class="form-group">
              <label>Denda</label>
