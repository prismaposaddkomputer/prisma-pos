        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" class="text-right">
              <a class="btn btn-primary" href="<?=base_url()?>hot_reservation/reservation_print_pdf/<?=$billing->billing_id?>">Cetak PDF <i class="fa fa-file-pdf-o"></i></a>
              <a class="btn btn-success" href="<?=base_url()?>hot_reservation/reservation_print_struk/<?=$billing->billing_id?>">Cetak Struk <i class="fa fa-print"></i></a>
            </td>
          </tr>
        </tbody>
      </table>
