    ...
    if ($data['billing']->billing_status !='3') {
      ...
      foreach ($data['get_billing_room'] as $row) {
        ...
        if ($row->room_st_denda !='2') {
          ...
          $jam_akhir_hari_berikutnya_lagi = date('Y-m-d H:i:s', strtotime('+'.round($row->room_type_duration,0,PHP_ROUND_HALF_UP).' days', strtotime($jam_akhir_hari_berikutnya)));
          ...
          // print("Jam Sekarang : ".$jam_sekarang." <br> Billing Time IN : ".$billing_time_in." <br> Jam Akhir : ".$jam_akhir." <br> Jam Akhir Hari Berikutnya ".$jam_akhir_hari_berikutnya." <br> Billing Out ".$billing_out." <br> Jam Akhir Hari Berikutnya Lagi ".$jam_akhir_hari_berikutnya_lagi);
          // exit();
            ...
            if ($jam_sekarang >= $jam_akhir_hari_berikutnya) {
              ...
              if ($row->room_type_tarif_kamar == '2') {
                ...
                $data_update_billing_room['room_type_subtotal'] = round($get_hot_room_type->room_type_charge,0,PHP_ROUND_HALF_UP)*$data_update_billing_room['room_type_duration'];
                  ...
                  $data_update_billing_room['room_type_total'] = $data_update_billing_room['room_type_before_discount']-$row->room_type_discount;
