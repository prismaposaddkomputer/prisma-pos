<div class="content-header">
  <h4>
    <a href="<?=base_url('res_bank')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
...
<div class="content-body">
  <div class="row">
    <form id="form" class="" action="<?=base_url()?>res_bank/<?=$action?>" method="post">
      <div class="col-md-6">
        ...
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>res_bank/index"><i class="fa fa-close"></i> Batal</a>
