...
<div class="content-body">
  <div class="row">
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>par_permission/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>par_permission/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($role as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-xs btn-success" href="<?=base_url()?>par_permission/form/<?=$row->role_id?>"><i class="fa fa-list"></i></a>
                  </td>
                  <td><?=$row->role_name?></td>
                </tr>
              <?php endforeach; ?>
