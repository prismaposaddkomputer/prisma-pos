...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>par_module/form"><i class="fa fa-plus"></i> Tambah Modul</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>par_module/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>par_module/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($row->module_id != '0'): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>par_module/form/<?=$row->module_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>par_module/delete/"+id;
    })
  }
</script>
