...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>kar_service/form"><i class="fa fa-plus"></i> Tambah Pelayanan Ruang</a>
    ...
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>kar_service/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>kar_service/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
        ...
        <table class="table table-striped table-bordered table-condensed">
          <thead>
            <tr>
              ...
              <th class="text-center">Nama Pelayanan Ruang</th>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->service_id != 0 ): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>kar_service/form/<?=$row->service_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>kar_service/delete/"+id;
    })
  }
</script>
...
<div class="modal fade" id="modalInformation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Informasi Menu Pelayanan Ruang</h4>
      </div>
      <div class="modal-body" style="font-size: 15px;">
        <ul style="margin-left: -22px;">
          <li>Menu ini digunakan untuk memanajemen Pelayanan Ruang, contoh Pelayanan Ruang seperti : Sarapan Pagi, Makan Malam, dll</li>
        </ul>
      </div>
      <div class="modal-footer">
