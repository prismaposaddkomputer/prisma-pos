...
<div class="content-body">
  <div class="row">
    <div class="col-md-5">
      <a class="btn btn-info" href="<?=base_url()?>kar_member/form"><i class="fa fa-plus"></i> Tambah Member (Tamu Langganan)</a>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>kar_member/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>kar_member/delete/"+id;
    })
  }
</script>
...
<div class="modal fade" id="modalInformation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Informasi Menu Member (Tamu Langganan)</h4>
      </div>
      <div class="modal-body" style="font-size: 15px;">
        <ul style="margin-left: -22px;">
          <li>Menu ini digunakan untuk memanajemen Member (Tamu Langganan)</li>
        </ul>
      </div>
      <div class="modal-footer">
