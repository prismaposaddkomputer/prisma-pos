...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>par_role/form"><i class="fa fa-plus"></i> Tambah Role</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>par_role/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>par_role/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($role as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->role_id != '' ): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>par_role/form/<?=$row->role_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>par_role/delete/"+id;
    })
  }
</script>
