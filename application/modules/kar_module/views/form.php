<div class="content-header">
  <h4>
    <a href="<?=base_url('kar_module')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
...
<div class="content-body">
  <div class="row">
    <form id="form" class="" action="<?=base_url()?>kar_module/<?=$action?>" method="post">
      <div class="col-md-8">
        ...
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>kar_module/index"><i class="fa fa-close"></i> Batal</a>
