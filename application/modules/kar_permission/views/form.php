<div class="content-header">
  <h4>
    <a href="<?=base_url('kar_permission')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="table-responsive">
        <form action="<?=base_url()?>kar_permission/<?=$action?>" method="post">
          ...
          <div class="form-group pull-right">
            <a class="btn btn-default" href="<?=base_url()?>kar_permission/index"><i class="fa fa-close"></i> Batal</a>
