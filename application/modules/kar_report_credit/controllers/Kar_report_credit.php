...
class Kar_report_credit extends MY_Karaoke {

  var $access, $report_selling_id;

  function __construct(){
    parent::__construct();
    if($this->session->userdata('menu') != 'kar_report_credit'){
      $this->session->set_userdata(array('menu' => 'kar_report_credit'));
	...
	public function index()
  {
    if ($this->access->_read == 1) {
      ...
      $this->view('kar_report_credit/index',$data);
    } else {
  ...
  public function action()
  {
    ...
    switch ($data['type']) {
      ...
      case 'annual':
        $year = $data['year'];
        redirect(base_url().'kar_report_credit/annual/'.$year);
        break;

      case 'monthly':
        $month = ind_to_month($data['month']);
        redirect(base_url().'kar_report_credit/monthly/'.$month);
        break;

      case 'weekly':
        $week = $data['week'];
        $week = str_replace(' - ', '/', $week);
        redirect(base_url().'kar_report_credit/weekly/'.$week);
        break;

      case 'daily':
        $date = ind_to_date($data['date']);
        redirect(base_url().'kar_report_credit/daily/'.$date);
        break;

      case 'range':
        $range = $data['range'];
        $range = str_replace(' - ', '/', $range);
        redirect(base_url().'kar_report_credit/range/'.$range);
        break;
  ...
  public function annual($year)
  {
    ...
    $data['year'] = $year;
    //
    $data['annual'] = $this->m_kar_report_credit->annual($year);
  ...
  public function annual_print($year)
  {
    ...
    //
    $annual = $this->m_kar_report_credit->annual($year);
  ...
  public function monthly($month)
  {
    ...
    $data['monthly'] = $this->m_kar_report_credit->monthly($month);
    $data['charge_type'] = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
  ...
  public function monthly_print($month)
  {
    ...
    $client = $this->m_kar_client->get_all();
    //
    $monthly = $this->m_kar_report_credit->monthly($month);
    $charge_type = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
  ...
  public function weekly($date_start, $date_end)
  {
    ...
    $data['weekly'] = $this->m_kar_report_credit->weekly(ind_to_date($date_start),ind_to_date($date_end));
    $data['charge_type'] = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
  ...
  public function weekly_print($date_start, $date_end)
  {
    ...
    $client = $this->m_kar_client->get_all();
    //
    $weekly = $this->m_kar_report_credit->weekly(ind_to_date($date_start),ind_to_date($date_end));
    $charge_type = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
    ...
    //
    redirect(base_url().'kar_report_credit/weekly/'.$date_start.'/'.$date_end);
  }
  ...
  public function daily($date)
  {
    ...
    $data['daily'] = $this->m_kar_report_credit->daily($date);
    $data['charge_type'] = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
  ...
  public function daily_print($date)
  {
    ...
    $client = $this->m_kar_client->get_all();
    //
    $daily = $this->m_kar_report_credit->daily($date);
    $charge_type = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
  ...
  public function range($date_start, $date_end)
  {
    ...
    $data['range'] = $this->m_kar_report_credit->range(ind_to_date($date_start),ind_to_date($date_end));
    $data['charge_type'] = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
  ...
  public function range_print($date_start, $date_end)
  {
    ...
    $client = $this->m_kar_client->get_all();
    //
    $range = $this->m_kar_report_credit->range(ind_to_date($date_start),ind_to_date($date_end));
    $charge_type = $this->m_kar_charge_type->list_data_except_tax_karaoke();
    //
    ...
    //
    redirect(base_url().'kar_report_credit/range/'.$date_start.'/'.$date_end);
  }
  ...
  {
    $data = $_POST;
    $this->view('kar_report_credit/frame_pdf', $data);
  }
