      ...
      <table class="table table-condensed">
        <tbody>
          ...
          <tr>
            ...
            <td width="20">:</td>
            <td><?=num_to_idr($billing->billing_total-$billing->billing_payment)?></td>
          </tr>
          <tr>
            <th width="300">Kembalian</th>
            <th width="20">:</th>
            <th><?=num_to_idr($billing->billing_total-$billing->billing_change)?></th>
          </tr>
          <tr>
            <td colspan="3" class="text-right">
              <a class="btn btn-primary" href="<?=base_url()?>kar_reservation/reservation_print_pdf/<?=$billing->billing_id?>">Cetak PDF <i class="fa fa-file-pdf-o"></i></a>
              <a class="btn btn-success" href="<?=base_url()?>kar_reservation/reservation_print_struk/<?=$billing->billing_id?>">Cetak Struk <i class="fa fa-print"></i></a>
            </td>
          </tr>
        </tbody>
      </table>
