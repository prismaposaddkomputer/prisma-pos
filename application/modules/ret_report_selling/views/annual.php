...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>ret_report_selling/annual_pdf/<?=$year?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
            ...
            <?php $i=1;foreach ($annual as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>ret_report_selling/monthly/<?=$row->tx_year?>-<?=str_pad($row->tx_month, 2, '0', STR_PAD_LEFT)?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
