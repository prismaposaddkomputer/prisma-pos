...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>res_void/form"><i class="fa fa-plus"></i> Tambah Void Penjualan</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>res_void/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>res_void/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($void as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->tx_id != 0 ): ?>
                      <a class="btn btn-xs btn-success" href="<?=base_url()?>res_void/detail/<?=$row->tx_id?>"><i class="fa fa-list"></i></a>
                    <?php endif; ?>
                  </td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>res_void/delete/"+id;
    })
  }
</script>
