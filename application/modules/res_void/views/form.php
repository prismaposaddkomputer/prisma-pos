...
<div class="content-body">
  <form id="form" class="" action="<?=base_url()?>res_void/<?=$action?>" method="post">
    <div class="row">
      <div class="col-md-3">
        <input class="form-control" type="hidden" name="tx_id" value="<?php if($void != null){echo $void->tx_id;}?>">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input class="form-control keyboard" type="text" name="void_notes" value="">
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <table style="background:white" class="table table-bordered table-">
          <thead>
            <tr>
              ...
              <th class="text-center" width="80">Banyak Void</th>
            </tr>
          </thead>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>res_void/index"><i class="fa fa-close"></i> Batal</a>
...
<script type="text/javascript">
  ...
  function get_billing() {
    ...
    $.ajax({
      type : 'post',
      url : '<?=base_url()?>res_void/get_billing',
        ...
        $.each(data.detail, function(i, item) {
          var row = '<tr>'+
            ...
            '<td class="text-center">'+
              '<input style="padding:0;height:24px;width:80px" type="text" name="void_amount[]" value="'+item.tx_amount+'" readonly>'+
            '</td>'+
          '</tr>';
