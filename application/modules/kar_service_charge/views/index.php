...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>kar_service_charge/form"><i class="fa fa-plus"></i> Tambah Service Charge</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>kar_service_charge/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>kar_service_charge/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
        ...
        <table class="table table-striped table-bordered table-condensed">
          <thead>
            <tr>
              ...
              <th class="text-center">Nama Service Charge</th>
              <th class="text-center" width="150">Harga</th>
              <th class="text-center" width="80">Aktif</th>
            </tr>
          </thead>
          <tbody>
            <?php if ($service_charge != null): ?>
              <?php $i=1;foreach ($service_charge as $row): ?>
                <tr>
                  <td class="text-center"><?=$this->uri->segment('3')+$i++?></td>
                  <td class="text-center">
                    <a class="btn btn-xs btn-warning" href="<?=base_url()?>kar_service_charge/form/<?=$row->service_charge_id?>"><i class="fa fa-pencil"></i></a>
                    <?php if ($row->service_charge_id != 0 ): ?>
                      <button class="btn btn-xs btn-danger" onclick="del('<?=$row->service_charge_id?>');"><i class="fa fa-trash"></i></button>
                    <?php endif; ?>
                  </td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>kar_service_charge/delete/"+id;
    })
  }
</script>
