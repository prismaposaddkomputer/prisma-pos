...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a href="<?=base_url()?>hot_report_payment/monthly/<?=$month?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
      <a class="btn btn-primary" href="<?=base_url()?>hot_report_payment/daily_pdf/<?=$date?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <a href="<?=base_url()?>hot_report_payment/daily_print/<?=$date?>" class="btn btn-warning"><i class="fa fa-print"></i> Print Laporan</a>
      <br><br>
            ...
            <?php foreach ($daily as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>hot_report_payment/detail/<?=$row->billing_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
