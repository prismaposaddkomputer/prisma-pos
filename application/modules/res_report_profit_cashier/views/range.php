...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>res_report_profit_cashier/range_pdf/<?=$date_start?>/<?=$date_end?>/<?=$user_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
