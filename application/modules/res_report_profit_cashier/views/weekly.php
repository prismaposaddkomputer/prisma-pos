...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>res_report_profit_cashier/weekly_pdf/<?=$date_start?>/<?=$date_end?>/<?=$user_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
            ...
            <?php $i=1;foreach ($weekly as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>res_report_profit_cashier/daily/<?=$row->tx_date?>/<?=$user_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
