      ...
      <table id="main" class="table table-striped table-bordered table-condensed">
        <thead>
          <tr>
            ...
            <th class="text-center">Penjualan<br><small>(Setelah Pajak)</small><br><small>(4+5)</small></th>
            <th class="text-center">Diskon</th>
            <th class="text-center">Keuntungan<br><small>(Sebelum Pajak)</small><br><small>(4-3-7)</small></th>
            <th class="text-center">Keuntungan<br><small>(Setelah Pajak)</small><br><small>(8-5)</small></th>
          </tr>
          <tr>
