  ...
  <body>
    ...
    <div class="container-fluid full-height-container">
      <div class="row full-height-row">
        <div id="item" class="col-md-8 col-xs-12 right full-height-col">
          <div id="search-form">
            <div class="row">
              <div class="col-md-3" style="height:10px">
                <div class="form-group">
                  <select class="form-control select2" name="" id="category_filter">
    ...
    <script>
      $('#category_filter').on('select2:select', function (e) {
        var id = e.params.data.id;
        if (id == '') {
          get_all_item();
        }else{
          get_item_by_category(id);
        }
      });
    </script>
  </body>
