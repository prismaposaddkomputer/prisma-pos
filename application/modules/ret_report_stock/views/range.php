  ...
  <div class="row">
    <div class="col-md-12">
      <div class="table-responsive">
        <a class="btn btn-primary" href="<?=base_url()?>ret_report_stock/range_pdf/<?=$date_start?>/<?=$date_end?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
        <br><br>
        <table class="table table-striped table-bordered table-condensed">
          ...
          <tbody>
            <?php if ($range != null): ?>
              <?php $i=1;foreach ($range as $key => $val): ?>
                <tr>
