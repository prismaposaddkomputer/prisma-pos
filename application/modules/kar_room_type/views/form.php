<div class="content-header">
  <h4>
    <a href="<?=base_url('kar_room_type')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
    ...
    <form id="form" class="" action="<?=base_url()?>kar_room_type/<?=$action?>" method="post">
      <div class="col-md-6">
        ...
        <div class="form-group">
          <label>Nama Tipe Room (Kategori Room) <small class="required-field">*</small></label>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="form-group">
              <label>Tarif Room <small class="required-field">**</small></label>
          ...
          <div class="col-md-5">
            <div class="form-group">
              <label>Jumlah Room <small class="required-field">*</small></label>
              <div class="input-group">
                  ...
                  <div class="input-group-addon"><b>Room</b></div>
              </div>
            </div>
          </div>
        </div>
