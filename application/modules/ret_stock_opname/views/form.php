    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>ret_stock_opname/index"><i class="fa fa-close"></i> Batal</a>
          <button class="btn btn-warning" type="submit" onclick="javascript: form.action='<?=base_url()?>ret_stock_opname/<?=$action_draft?>';"><i class="fa fa-edit"></i> Simpan Sementara</button>
          <button class="btn btn-info" type="submit" onclick="javascript: form.action='<?=base_url()?>ret_stock_opname/<?=$action?>';"><i class="fa fa-save"></i> Simpan</button>
        </div>
      </div>
    </div>
  </form>
