...
<div class="content-body">
  <div class="row">
    <form id="form" class="" action="<?=base_url()?>ret_customer/<?=$action?>" method="post">
      <div class="col-md-6">
        ...
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>ret_customer/index"><i class="fa fa-close"></i> Batal</a>
