        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" class="text-right">
                <a href="<?=base_url()?>kar_report_payment/daily/<?=$billing->billing_date_in?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
                <a href="<?=base_url()?>kar_reservation/frame_pdf/<?=$id?>/kar_report_payment" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> Print PDF</a>
                <a href="<?=base_url()?>kar_reservation/reservation_print_struk/<?=$id?>/kar_report_payment" class="btn btn-warning"><i class="fa fa-print"></i> Print Laporan</a>
            </td>
          </tr>
        </tbody>
      </table>
