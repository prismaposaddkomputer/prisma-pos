  ...
  <div class="row">
    <div class="col-md-12">
      <form method="post" action="<?=base_url()?>kar_report_payment/frame_pdf">
        <a href="<?=base_url()?>kar_report_payment/monthly/<?=$month?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
        <input type="hidden" name="url" value="<?=base_url()?>kar_report_payment/daily_pdf/<?=$date?>">
        <button class="btn btn-primary" type="submit"><i class="fa fa-print"></i> Download PDF</button>
        <a href="<?=base_url()?>kar_report_payment/daily_print/<?=$date?>" class="btn btn-warning"><i class="fa fa-print"></i> Print Laporan</a>
      </form>
      <br><br>
            ...
            <?php foreach ($daily as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>kar_report_payment/detail/<?=$row->billing_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
