...
class Hot_fnb extends MY_Hotel {
	...
	public function index()
  {
    if ($this->access->_read == 1) {
      ...
      if($this->session->userdata('search_term') == null){
        ...
        $data['fnb_type'] = $this->m_hot_fnb->get_list($config['per_page'],$from,$search_term = null);
      }else{
        ...
        $data['fnb_type'] = $this->m_hot_fnb->get_list($config['per_page'],$from,$search_term);
      }
  ...
  {
    $data['fnb_type']= $this->m_hot_fnb->get_specific($id);
