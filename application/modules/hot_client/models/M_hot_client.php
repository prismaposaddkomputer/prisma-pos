...
class M_hot_client extends CI_Model {
  ...
  {
    return $this->db->where('client_id',$id)->get('hot_client')->row();
  }

  public function get_last()
  {
    return $this->db->order_by('client_id','desc')->get('hot_client')->row();
  }

  public function insert($data)
  {
    $this->db->insert('hot_client',$data);
  }
  ...
  {
    $this->db->where('client_id',$id)->delete('hot_client');
  }

	function num_rows($search_term = null){
		if($search_term == null){
			return $this->db->get('hot_client')->num_rows();
		}else{
			return $this->db->like('client_name',$search_term,'both')->get('hot_client')->num_rows();
		}
	}
