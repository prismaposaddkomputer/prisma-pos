...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>hot_report_receptionist/weekly_pdf/<?=$date_start?>/<?=$date_end?>/<?=$user_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <a href="<?=base_url()?>hot_report_receptionist/weekly_print/<?=$date_start?>/<?=$date_end?>/<?=$user_id?>" class="btn btn-warning"><i class="fa fa-print"></i> Print Laporan</a>
      <br><br>
