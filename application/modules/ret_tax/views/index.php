...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>ret_tax/form"><i class="fa fa-plus"></i> Tambah Pajak</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>ret_tax/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>ret_tax/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->tax_id != null ): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>ret_tax/form/<?=$row->tax_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>ret_tax/delete/"+id;
    })
  }
</script>
