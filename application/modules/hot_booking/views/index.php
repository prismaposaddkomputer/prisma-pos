...
<div class="content-body">
  <div class="row">
  <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>hot_booking/form"><i class="fa fa-plus"></i> Tambah Pemesanan Kamar</a>
    </div>
  ...
  <div class="row">
    ...
    <div class="well" style="display:none;">
					<form class="form-horizontal" method="GET" action="<?=base_url()?>hot_booking/index">
					<div class="form-group">
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>hot_booking/delete/"+id;
    })
  }
</script>
