...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>ret_report_selling_customer/range_pdf/<?=$date_start?>/<?=$date_end?>/<?=$customer_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
