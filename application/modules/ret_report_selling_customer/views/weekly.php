...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>ret_report_selling_customer/weekly_pdf/<?=$date_start?>/<?=$date_end?>/<?=$customer_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
            ...
            <?php $i=1;foreach ($weekly as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>ret_report_selling_customer/daily/<?=$row->tx_date?>/<?=$customer_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
