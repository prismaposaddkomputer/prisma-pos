...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>ret_report_selling_customer/daily_pdf/<?=$date?>/<?=$customer_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
            ...
            <?php foreach ($daily as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>ret_report_selling_customer/detail/<?=$row->tx_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
