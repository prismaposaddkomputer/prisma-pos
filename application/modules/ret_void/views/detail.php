      ...
      <table class="table table-condensed table-striped">
        <tbody>
          ...
          <tr>
            <td>Tanggal/Waktu</td>
            <td>:</td>
            <td><?=ind_to_date($void->tx_date)?> <?=$void->tx_time?></td>
          </tr>
          <tr>
            <td>Alasan</td>
            <td>:</td>
            <td><?=$void->void_notes?></td>
          </tr>
        </tbody>
      </table>
    </div>
