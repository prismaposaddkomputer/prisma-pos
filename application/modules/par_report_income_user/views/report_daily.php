<div class="content-header">
  <a class="btn btn-success pull-right" target="" href="<?=base_url()?>par_report_income_user/report_daily_pdf/<?=$date?>/<?=$user_id?>"><i class="fa fa-file-pdf-o"></i> Download PDF</a>
