...
<div class="content-body">
  <div class="row">
    <div class="col-md-6">
      <a class="btn btn-primary" href="<?=base_url()?>kar_report_billing_cashier/range_pdf/<?=$date_start?>/<?=$date_end?>/<?=$user_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
