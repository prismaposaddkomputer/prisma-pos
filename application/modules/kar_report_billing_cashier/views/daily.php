...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <a class="btn btn-primary" href="<?=base_url()?>kar_report_billing_cashier/daily_pdf/<?=$date?>/<?=$user_id?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
      <br><br>
            ...
            <?php foreach ($daily as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>kar_report_billing_cashier/detail/<?=$row->tx_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
