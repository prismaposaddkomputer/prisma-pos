...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          <li>
            <a href="<?=base_url()?>ret_dashboard/index" role="button">Prisma POS</a>
          </li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="<?=base_url()?>ret_cashier/shift/close"><i class="fa fa-sign-out"></i> Tutup Shift</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div id="modal_add_customer" class="modal fade bs-example-modal-sm" role="dialog" aria-labelledby="mySmallModalLabel">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <form id="form_add_customer" action="<?=base_url()?>ret_cashier/add_customer" method="post">
            <div class="modal-header">
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $('#customer_list').on('change', function() {
          $.ajax({
            type: 'post',
            url: '<?=base_url()?>ret_cashier/get_detail_customer',
      ...
      function getHoldBilling() {
        $.ajax({
          type: 'post',
          url: '<?=base_url()?>ret_cashier/get_hold_billing',
          dataType: 'json',
          success: function(data) {
            console.log(data);
      ...
      function get_billing_id(tx_id) {
        ...
        $.ajax({
          type: 'post',
          url : '<?=base_url()?>ret_cashier/get_billing_now',
          data : 'tx_id='+tx_id,
          dataType : 'json',
          success : function (data) {
      ...
      function new_billing() {
        ...
        $.ajax({
          type: 'post',
          url: '<?=base_url()?>ret_cashier/new_billing',
          dataType: 'json',
          success: function (data) {
            // first customer
      ...
      function get_all_item() {
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/get_all_item',
          dataType : 'json',
          success : function (data) {
            append_item(data);
          }
      ...
      function get_item_by_category(id) {
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/get_item_by_category',
          data : 'category_id='+id,
          dataType : 'json',
          success : function (data) {
            append_item(data);
      ...
      function get_item_search() {
        ...
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/get_item_search',
      ...
      function add_item_show(id) {
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/add_item_show',
          data : 'item_id='+id,
          dataType : 'json',
          success : function (data) {
      ...
      function add_item_action() {
        ...
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/add_item_action',
      ...
      function edit_item_show(id) {
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/edit_item_show',
      ...
      function edit_item_action()
      {
        ...
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/edit_item_action',
      ...
      function delete_item_action()
      {
        ...
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/delete_item_action',
      ...
      function pending_action() {
        ...
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/pending_action',
          data : 'tx_id='+tx_id,
          success : function () {
      ...
      function get_customer() {
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/get_customer',
          dataType : 'json',
          success : function (data) {
            $("#customer_list").html('');
            $.each(data, function() {
      ...
      function cancel_action() {
        ...
        $.ajax({
          type : 'post',
          url : '<?=base_url()?>ret_cashier/cancel_action',
      ...
      function printBill() {
        ...
        $.ajax({
          type: 'post',
          url : '<?=base_url()?>ret_cashier/print_bill',
          data : 'tx_id='+tx_id,
          success : function () {
      ...
      function action_search() {
        ...
        if (search_name != '') {
          $.ajax({
            type: 'post',
            url : '<?=base_url()?>ret_cashier/search_action',
