...
<div class="content-body">
  <div class="row">
    <form id="form" class="" action="<?=base_url()?>res_user/<?=$action?>" method="post">
      <div class="col-md-6">
        ...
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>res_user/index"><i class="fa fa-close"></i> Batal</a>
  ...
  <div class="row">
    <form id="form_password" class="" action="<?=base_url()?>res_user/update_password" method="post">
      <div class="col-md-6">
