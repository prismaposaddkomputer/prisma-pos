...
<div class="row">
		<div class="col-lg-3 col-md-3 col-sm-6">
          ...
          <a class="btn btn-info btn-block" href="<?=base_url()?>hot_report_reservation/daily/<?=date("Y-m-d")?>">Lihat</a>
				</div>
			</div>
		</div>
        ...
        <div class="panel-heading text-center">
          <h3 class="panel-title">Jumlah Total Reservasi</h3>
				...
				<div class="panel-footer">
          <a class="btn btn-info btn-block" href="<?=base_url()?>hot_reservation">Lihat</a>
				</div>
			</div>
		</div>
        ...
        <div class="panel-heading text-center">
          <h3 class="panel-title">Jumlah Tamu Langganan</h3>
				...
				<div class="panel-footer">
            <a class="btn btn-info btn-block" href="<?=base_url()?>hot_guest/index/ada">Lihat</a>
				</div>
			</div>
		</div>
