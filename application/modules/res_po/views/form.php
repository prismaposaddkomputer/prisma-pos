<div class="content-header">
  <h4>
    <a href="<?=base_url('res_po')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
    <i class="fa fa-<?=$access->module_icon?>"></i> <?=$title?>
  </h4>
  <small>Kolom dengan tanda <b class="required-field">*</b> wajib diisi!</small>
</div>
<div class="content-body">
  <form id="form" class="" action="<?=base_url()?>res_po/<?=$action?>" method="post">
    <div class="row">
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="form-group pull-right">
          <a class="btn btn-default" href="<?=base_url()?>res_po/index"><i class="fa fa-close"></i> Batal</a>
    ...
    <div class="modal-content">
      <form id="form_item" action="#" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Jumlah</label>
            <input id="po" class="form-control num" name="po" type="number" value="">
          </div>
          <div class="form-group">
