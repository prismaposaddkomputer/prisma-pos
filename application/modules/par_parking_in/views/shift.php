...
<div class="content-body">
  <div class="row">
    <div class="col-md-12">
      <form id="form" class="" action="<?=base_url()?>par_parking_in/<?=$action?>" method="post">
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group pull-right">
                ...
                <?php else: ?>
                  <a class="btn btn-default" href="<?=base_url()?>par_parking_in"><i class="fa fa-close"></i>Batal</a>
