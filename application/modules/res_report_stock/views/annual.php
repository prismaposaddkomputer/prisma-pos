  ...
  <div class="row">
    <div class="col-md-12">
      <div class="table-responsive">
        <a class="btn btn-primary" href="<?=base_url()?>res_report_stock/annual_pdf/<?=$year?>" target="_blank"><i class="fa fa-print"></i> Download PDF</a>
        <br><br>
        <table class="table table-striped table-bordered table-condensed">
          ...
          <tbody>
            <?php if ($annual != null): ?>
              <?php $i=1;foreach ($annual as $key => $val): ?>
                <tr>
