...
<div class="content-body">
  <div class="row">
    ...
    <div class="col-md-8 col-lg-7 pull-right">
      <form class="" action="<?=base_url()?>res_stock_recap/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>res_stock_recap/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
    </div>
