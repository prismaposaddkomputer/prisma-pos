...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>par_brand/form"><i class="fa fa-plus"></i> Tambah Kategori</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>par_brand/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>par_brand/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($brand as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->brand_id != 0 ): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>par_brand/form/<?=$row->brand_id?>"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-danger" onclick="del('<?=$row->brand_id?>');"><i class="fa fa-trash"></i></button>
                    <?php endif; ?>
                  </td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>par_brand/delete/"+id;
    })
  }
</script>
