...
<div class="content-body">
  <div class="row">
    <div class="col-md-8 col-lg-7 pull-right">
      <form class="" action="<?=base_url()?>ret_report/report_stock" method="post">
        <div class="form-group">
          <div class="input-group">
            <input type="text" class="form-control daterange-picker" name="search_stock" value="<?php echo $this->session->userdata('search_stock');?>">
            <span class="input-group-btn">
              <button class="btn btn-info" type="submit"><i class="fa fa-search"></i></button>
              <a class="btn btn-default" href="<?=base_url()?>ret_report/reset_stock"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <?php if ($this->session->userdata('search_stock')): ?>
        <i class="search_result">Hasil pencarian dengan kata kunci: <b><?=$this->session->userdata('search_stock');?></b></i><br><br>
      <?php endif; ?>
