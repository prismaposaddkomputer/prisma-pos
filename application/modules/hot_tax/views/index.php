...
<div class="content-body">
  <div class="row">
    ...
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>hot_tax/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>hot_tax/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($tax as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <?php if ($row->tax_id != 0 ): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>hot_tax/form/<?=$row->tax_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>hot_tax/delete/"+id;
    })
  }
</script>
