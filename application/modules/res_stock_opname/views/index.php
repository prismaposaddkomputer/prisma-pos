...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>res_stock_opname/form"><i class="fa fa-plus"></i> Tambah Stok Opname</a>
    </div>
    <div class="col-md-8 col-lg-7 pull-right">
      <form class="" action="<?=base_url()?>res_stock_opname/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>res_stock_opname/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
    </div>
                  ...
                  <td class="text-center">
                    <?php if ($row->tx_id != '' ): ?>
                      <?php if ($row->tx_status == 0): ?>
                        <a class="btn btn-xs btn-warning" href="<?=base_url()?>res_stock_opname/form/<?=$row->tx_id?>"><i class="fa fa-pencil"></i></a>
                      <?php endif; ?>
                      <a class="btn btn-xs btn-success" href="<?=base_url()?>res_stock_opname/detail/<?=$row->tx_id?>/<?=$row->tx_type?>"><i class="fa fa-list"></i></a>
                    <?php endif; ?>
                  </td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>res_stock_opname/delete/"+id;
    })
  }
</script>
