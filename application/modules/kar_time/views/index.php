...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <!-- <a class="btn btn-info" href="<?=base_url()?>kar_time/form"><i class="fa fa-plus"></i> Tambah Waktu</a> -->
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>kar_time/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>kar_time/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
        ...
        <table class="table table-striped table-bordered table-condensed">
          <thead>
            <tr>
              ...
              <th class="text-center" width="200">Waktu Mulai</th>
              <th class="text-center" width="200">Waktu Akhir</th>
              <th class="text-center" width="80">Aktif</th>
            </tr>
          </thead>
          <tbody>
            <?php if ($time != null): ?>
              <?php $i=1;foreach ($time as $row): ?>
                <tr>
                  <td class="text-center"><?=$this->uri->segment('3')+$i++?></td>
                  <td class="text-center">
                    <?php if ($row->time_id != 0 ): ?>
                      <a class="btn btn-xs btn-warning" href="<?=base_url()?>kar_time/form/<?=$row->time_id?>"><i class="fa fa-pencil"></i></a>
                      <!-- <button class="btn btn-xs btn-danger" onclick="del('<?=$row->time_id?>');"><i class="fa fa-trash"></i></button> -->
                    <?php endif; ?>
                  </td>
                  <td><?=$row->time_name?></td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>kar_time/delete/"+id;
    })
  }
</script>
