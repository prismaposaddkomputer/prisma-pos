...
<div class="content-body">
  <div class="row">
    <div class="col-md-8 col-lg-7 pull-right">
      <form class="" action="<?=base_url()?>res_report/report_profit_daily" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>res_report/reset_profit_daily"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
    </div>
