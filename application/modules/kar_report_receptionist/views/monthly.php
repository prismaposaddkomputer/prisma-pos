  ...
  <div class="row">
    <div class="col-md-12">
      <form method="post" action="<?=base_url()?>kar_report_receptionist/frame_pdf">
        <a href="<?=base_url()?>kar_report_receptionist/annual/<?=$year?>/<?=$user_id?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
        <input type="hidden" name="url" value="<?=base_url()?>kar_report_receptionist/monthly_pdf/<?=$month?>/<?=$user_id?>">
        <button class="btn btn-primary" type="submit"><i class="fa fa-print"></i> Download PDF</button>
        <a href="<?=base_url()?>kar_report_receptionist/monthly_print/<?=$month?>/<?=$user_id?>" class="btn btn-warning"><i class="fa fa-print"></i> Print Laporan</a>
      </form>
      <br><br>
            ...
            <?php $i=1;foreach ($monthly as $row): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?=base_url()?>kar_report_receptionist/daily/<?=$row->billing_date_in?>/<?=$user_id?>" class="btn btn-xs btn-success"><i class="fa fa-list"></i> </a>
                </td>
