...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>ret_return/form"><i class="fa fa-plus"></i> Tambah Retur Penjualan</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>ret_return/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>ret_return/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
    ...
    <div class="col-md-12">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-condensed">
          <thead>
            <tr>
              <!-- <th class="text-center" width="80">ID Retur</th> -->
          ...
          <tbody>
            <?php if ($return != null): ?>
              <?php $i=1;foreach ($return as $row): ?>
                <tr>
                  <!-- <td class="text-center">TXR-<?=$row->tx_id?></td> -->
                  <td class="text-center">TXS-<?=$row->tx_receipt_no?></td>
                  <td class="text-center">
                    <?php if ($row->tx_id != 0 ): ?>
                      <a class="btn btn-xs btn-success" href="<?=base_url()?>ret_return/detail/<?=$row->tx_id?>"><i class="fa fa-list"></i></a>
                    <?php endif; ?>
                  </td>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>ret_return/delete/"+id;
    })
  }
</script>
