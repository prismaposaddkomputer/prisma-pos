<div class="content-header">
  <h4>
    <a href="<?=base_url('kar_client')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
...
<div class="content-body">
  <div class="row">
    <form id="form" action="<?=base_url()?>kar_client/<?=$action?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      <div class="col-md-6">
