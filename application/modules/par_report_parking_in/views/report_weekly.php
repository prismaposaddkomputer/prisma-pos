<div class="content-header">
  <a class="btn btn-success pull-right" target="_blank" href="<?=base_url()?>par_report_parking_in/report_weekly_pdf/<?=$date_start?>/<?=$date_end?>"><i class="fa fa-file-pdf-o"></i> Download PDF</a>
