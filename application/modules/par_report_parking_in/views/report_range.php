<div class="content-header">
  <a class="btn btn-success pull-right" target="" href="<?=base_url()?>par_report_parking_in/report_range_pdf/<?=$date_start?>/<?=$date_end?>"><i class="fa fa-file-pdf-o"></i> Download PDF</a>
