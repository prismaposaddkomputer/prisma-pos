...
<div class="content-body">
  <div class="row">
    <div class="col-md-4">
      <a class="btn btn-info" href="<?=base_url()?>res_customer/form"><i class="fa fa-plus"></i> Tambah Pelanggan</a>
    </div>
    <div class="col-md-4 pull-right">
      <form class="" action="<?=base_url()?>res_customer/index" method="post">
        <div class="form-group">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              ...
              <a class="btn btn-default" href="<?=base_url()?>res_customer/reset_search"><i class="fa fa-refresh"></i></a>
            </span>
          </div>
        </div>
      </form>
              ...
              <?php $i=1;foreach ($customer as $row): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-xs btn-warning" href="<?=base_url()?>res_customer/form/<?=$row->customer_id?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
  function del(id) {
    ...
    $("#btn_delete_action").click(function () {
      window.location = "<?=base_url()?>res_customer/delete/"+id;
    })
  }
</script>
