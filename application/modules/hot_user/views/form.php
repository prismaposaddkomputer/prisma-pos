<div class="content-header">
  <h4>
    <a href="<?=base_url('hot_user')?>" class="btn btn-success"><i class="fa fa-arrow-left"></i></a> 
...
<div class="content-body">
  ...
  <div class="row">
    <form id="form_password" class="" action="<?=base_url()?>hot_user/update_password" method="post">
      <div class="col-md-6">
